...
function [res, a_2, a_3] = hx(x, theta_1, theta_2)

  a_2 = sigmoid(theta_1 * [1;x]);
  a_2 = [1;a_2];
...
for i=1:m
  ...
  the_y = ([1:num_labels]' ==y(i) );
  [temp_hx , a_2, a_3] = hx(X(i,:)', Theta1, Theta2);
  J = J + sum(-the_y' *log(temp_hx) - (1-the_y')*log(1-temp_hx));

  delta_3 = temp_hx - the_y;

  delta_2 = (Theta2' * delta_3) .* a_2 .* (1-a_2);

  Theta2_grad = Theta2_grad +  delta_3 * a_2';
  Theta1_grad = Theta1_grad +  delta_2(2:end) * [1 X(i,:)];
